...
public class Jugador {
	...
	public Jugador(double posicionX, double posicionY, Mapa mapa) {
		...
		hs = new HojaSprites("/imagenes/hojasPersonajes/avatar-alone.png", Constantes.LADO_SPRITE, false);
	...
	private boolean colisionArriba(int velocidadY) {
		for ( int r = 0; r < mapa.areasColision.size(); r++) {
			final Rectangle area_personaje = mapa.areasColision.get(r);
	...
	private boolean fueraMapa(final int velocidadX, final int velocidadY) {
		...
		final Rectangle bordeMapa = mapa.getBordes(posicionFuturaX, posicionFuturaY, ANCHO_JUGADOR, ALTO_JUGADOR);
	...
	public void dibujar(Graphics g) {
		...
		g.drawString("Resistencia: "+resistencia, 20, 95);
